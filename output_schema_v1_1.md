...
**reasoning:**
- Maximum TWO short sentences written for a health coach, not a clinician
- Sentence 1: Lead with the primary signal and exact value. Example: "FBS 165 mg/dL above threshold with medication missed and stress 5/5 for third consecutive day."
- Sentence 2: One clear action word. Example: "Same-day contact recommended." or "Check in within 24 hours." or "Note at next scheduled contact."
- Never start with "The patient" or "Patient"
- Always include at least one specific number from the log
- No diagnostic language, no prescriptive language
